...
const CategoryDetailsModal = ({ isOpen, closeModal, categoryDetails}) => {
                ...
                <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-green-100 p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="max-w-xs p-6 rounded-md shadow-md mx-auto bg-green-50 ">
                    ...
                    <div className="mt-6 mb-2">
                      ...
                      <span className=" text-sm font-semibold">Medicine Name:</span> {categoryDetails?.medicineName} _ {categoryDetails?.price}$
                      </span>
                      <br />
                      <span className="  tracking-wide ">
                      <span className=" text-sm font-semibold">Category Name:</span> {categoryDetails?.categoryName}
                      </span>
                      <br />
                      <span className="  tracking-wide ">
                      <span className=" text-sm font-semibold">Description:</span> {categoryDetails?.description}
                      </span>
                    </div>
                  </div>
